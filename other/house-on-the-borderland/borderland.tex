...
\input{borderland-components/borderland-00-introduction.txt}
\input{borderland-components/borderland-01.txt}
\input{borderland-components/borderland-02.txt}
\input{borderland-components/borderland-03.txt}
\input{borderland-components/borderland-04.txt}
\input{borderland-components/borderland-05.txt}
\input{borderland-components/borderland-06.txt}
\input{borderland-components/borderland-07.txt}
\input{borderland-components/borderland-08.txt}
\input{borderland-components/borderland-09.txt}
\input{borderland-components/borderland-10.txt}
\input{borderland-components/borderland-11.txt}
\input{borderland-components/borderland-12.txt}
\input{borderland-components/borderland-13.txt}
\input{borderland-components/borderland-14.txt}
\input{borderland-components/borderland-15.txt}
\input{borderland-components/borderland-16.txt}
\input{borderland-components/borderland-17.txt}
\input{borderland-components/borderland-18.txt}
\input{borderland-components/borderland-19.txt}
\input{borderland-components/borderland-20.txt}
\input{borderland-components/borderland-21-conclusion.txt}
